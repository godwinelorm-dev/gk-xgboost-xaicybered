...
The ablation shows these two are **complementary**: focal loss alone underperforms
the baseline; only the combination improves minority detection.
...
GK-XGBoost improves all four metrics over the standard baseline; the **AUC-PR gain
(+0.0104) is statistically significant** (Wilcoxon W = 68, p = 0.0096, Cohen's d = 0.23).
High-Risk recall improves from 0.162 to 0.173. Internal consistency of the
behaviour scale: Cronbach's alpha = 0.68.
